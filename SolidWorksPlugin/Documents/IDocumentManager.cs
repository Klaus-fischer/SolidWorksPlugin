...
namespace SIM.SolidWorksPlugin
{
    ...
    /// It handles with <see cref="SwDocument"/> wrapper.
    /// </summary>
    public interface IDocumentManager
    {
        ...
        /// <returns>The loaded document wrapped in <see cref="SwDocument"/> class.</returns>
        ...
        void ReloadDocument(SwDocument document, bool readOnly);
